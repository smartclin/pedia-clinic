...
export const PrescribedItemShape = z
  .object({
...
export const PrescribedItemBaseSchema = PrescribedItemShape
  .refine(
    data => {
...
export const PrescribedItemUpdateSchema =
  PrescribedItemShape.partial().extend({
    id: idSchema,
  })
...
export const PrescriptionBaseSchema = z
  .object({
    ...
    prescribedItems: z
      .array(PrescribedItemShape.omit({ prescriptionId: true }))
...
export const PrescriptionCreateSchema = PrescribedItemShape.extend({
  clinicId: clinicIdSchema, // Required for create
})

export const PrescriptionUpdateSchema = PrescribedItemShape.partial().extend(
  {
    id: idSchema,
  }
)
