...
export async function getPatientPayments(patientId: string, clinicId: string) {
	'use cache'
	cacheTag(
...
export async function getPaymentRecords(input: {
	clinicId: string
	page: number
	limit?: number
	search?: string
...
export async function getRecentPayments(input: {
	clinicId: string
	page: number
	limit?: number
	search?: string
...
export async function getPaymentById(id: string, clinicId: string) {
	'use cache'
	cacheTag(
...
export async function generateBill(input: PaymentInput, userId: string) {
...
export async function addNewBill(input: AddNewBillInput, userId: string) {
	const {
		appointmentId,
		billId,
		quantity,
